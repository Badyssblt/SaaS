...
function AsideMenu({onClick}) {
  ...
  return (
    <div className='flex flex-row justify-between gap-6 px-6 py-2 bg-white fixed bottom-0 w-full border-t-2 z-50 md:static md:flex-col md:w-96 md:justify-normal md:z-0'>
